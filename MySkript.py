...
class Tank(object):
    ...
    def __init__(self):
        ...
        self.shell = Shell()
        self.image = pg.image.load("pics/tank/tank_model_1_c.png")
        self.s_image = pg.transform.scale(self.image, (50, 50))
    ...
    def draw(self, display):
        ...
        #r_image = pg.transform.rotate(self.s_image, 45)

        # making a copy of the old center of the rectangle
        old_center = self.rect.center
        # rotating the orignal image
        new_image = pg.transform.rotate(self.s_image, 0)
        self.rect = new_image.get_rect()
        # set the rotated rectangle to the old center
        self.rect.center = old_center
        # drawing the rotated rectangle to the screen
        display.blit(new_image, self.rect)
